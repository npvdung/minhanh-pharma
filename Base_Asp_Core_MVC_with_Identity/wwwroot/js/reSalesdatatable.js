$(document).ready(function () {
    $("#customerDatatable").DataTable({
        ...
        "columns": [
            ...
            //{ "data": "importName", "name": "importName", "autoWidth": true },
            {
                "data": "invoiceDate",
                "name": "invoiceDate",
                "autoWidth": true,
            ...
            { "data": "customName", "name": "customName", "autoWidth": true },
            {
                "data": "totalAmount",
                "name": "totalAmount",
                "autoWidth": true,
            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return `<a href="/ReSalse/Edit/${Id}" class="btn btn-primary center-block m-1">Sửa</a>`;
                }
            },
            //{
            //    "targets": 1,
