...
namespace Base_Asp_Core_MVC_with_Identity.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<UserSystemIdentity> _signInManager;
        private readonly UserManager<UserSystemIdentity> _userManager;
        private readonly IUserStore<UserSystemIdentity> _userStore;
        private readonly IUserEmailStore<UserSystemIdentity> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<UserSystemIdentity> userManager,
            IUserStore<UserSystemIdentity> userStore,
            SignInManager<UserSystemIdentity> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new UserSystemIdentity
                {
                    UserName = userName,
                    Email = Input.Email,
        ...
        private UserSystemIdentity CreateUser()
        {
            try
            {
        ...
        private IUserEmailStore<UserSystemIdentity> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<UserSystemIdentity>)_userStore;
        }
    }
}
